...
*/}}
{{- define "fitness-app-chart.fullname" -}}
...
{{ include "fitness-app-chart.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "fitness-app-chart.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "fitness-app-chart.fullname" .) .Values.serviceAccount.name }}
{{- else }}
